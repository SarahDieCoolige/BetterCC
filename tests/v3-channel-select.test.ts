...
const CCC = [
  "Registriert", 1, 1, "userwelcome.gif",
  "Chatcity", 1, 1, "userwelcome.gif",
  "Zauberwald", 1, 1, "zauberwald.gif",
  "Bizarre-Talk", 1, 1, "bizzare.gif",
  "Herzklopfen", 1, 1, "herzklopfen.gif",
  "Knuddelecke", 1, 1, "knuddelecke.gif",
  "Hexensabbat", 1, 1, "userwelcome.gif",
  "Bluemchensex", 1, 1, "userwelcome.gif",
  "Man-Street", 1, 1, "userwelcome.gif",
  "Fortysomething", 1, 1, "userwelcome.gif",
  "Trauminsel", 1, 1, "trauminsel.gif",
  "Goldenfifty", 1, 1, "golden50.gif",
  "Herzschmerz", 1, 1, "herzschmerz.gif",
  "nerdkultur", 1, 1, "userwelcome.gif",
  "query", 1, 1, "userwelcome.gif",

  "Erotik", 1, 2, "erotik.gif",
  "Erotik2", 1, 2, "erotik2.gif",
  "Erotik3", 1, 2, "erotik_03.gif",
  "Erotik4", 1, 2, "erotik_04.gif",
  "Gay-Cruising", 1, 2, "gaycruising.gif",
  "Women-Corner", 1, 2, "womencorner.gif",
  "EroRsp", 1, 2, "erorsp.gif",

  "International", 1, 3, "userwelcome.gif",
  "Baklava", 1, 3, "userwelcome.gif",
];
...
describe("parseChannels — real fixture data", () => {
  ...
  it("collects all Klassik channels into the first group", () => {
    ...
    expect(groups[0].channels).toEqual([
      "Registriert", "Chatcity", "Zauberwald", "Bizarre-Talk", "Herzklopfen",
      "Knuddelecke", "Hexensabbat", "Bluemchensex", "Man-Street", "Fortysomething",
      "Trauminsel", "Goldenfifty", "Herzschmerz", "nerdkultur", "query",
    ]);
  });
  ...
  it("routes Erotik channels to group 2 and International to group 3", () => {
    ...
    expect(groups[1].channels).toEqual([
      "Erotik", "Erotik2", "Erotik3", "Erotik4", "Gay-Cruising", "Women-Corner", "EroRsp",
    ]);
...
describe("parseChannels — tolerance", () => {
  ...
  it("skips a trailing partial tuple (length not a multiple of 4)", () => {
    ...
    const ccc = [
      ...
      "C", 1, 2, "x",
      "D", 1, 2, "x",
      "stray", 1, // partial — incomplete tuple
    ];
    const groups = parseChannels(ccc, CCG);
